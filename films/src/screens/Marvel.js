...
class Marvel extends Component {
  ...
  componentDidMount = async () => {
    try {
      const response = await fetch('https://api.themoviedb.org/3/search/movie?api_key=a964deeba065cbe2b07496c8bb84855a&language=ru-RU&query=marvel&page=1&include_adult=false')
