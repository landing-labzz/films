...
const ImageCard = ({ data, onPress, image,imageActor }) => {
  const { container, sub, h1, cover } = styles

  let imgRes = (data.poster_path === null)
  ? imageActor
  : data.poster_path
      ...
      <TouchableOpacity onPress={onPress}>
        <View style={container}>
          <View style={sub}>
            ...
            <View style={styles.blockAverage}>
              <Text style={styles.averageText}>{data.vote_average}</Text>
            </View>
          </View>
